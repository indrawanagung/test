    ...
    >
      <div className="w-full px-2 py-4">
        <MaxWidthWrapper>
          <div className="relative flex flex-col md:flex-row gap-4 w-full justify-between">
            ...
            {/* INPUT SEARCH  */}
            <div className="flex justify-between items-center w-full md:w-1/2 px-2 py-2 mt-1 border-[1px] border-gray-300 bg-white rounded-lg">
              ...
              />
              <MagnifyingGlass size={20} className="font-light text-gray-500" />
            </div>
            {/* RIGHT MENU MOBILE */}
            <RightMenuNavbar />
            {/* RIGHT MENU  */}
      ...
      <MaxWidthWrapper className="my-3 hidden lg:block">
        <div className="relative flex flex-col md:flex-row gap-9 w-full justify-start items-center">
          ...
          />
          <Link href="/" className="text-gray-500 text-[15px] tracking-wider">Home</Link>
