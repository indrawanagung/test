  ...
  return (
    <>
     {products?.map((product) => (
                ...
                <div key={product.ID}  data-aos="fade-up" className="flex flex-col max-w-56 min-w-56 gap-2 cursor-pointer border rounded-xl border-gray-200 ">
                  <Image
                  ...
                  <div className="flex flex-col gap-2 py-2 px-4">
                    ...
                    <div className="flex justify-between">
                      <span className="font-extrabold text-xl text-gray-600">{toRupiah(product.VariationOptions[0].Price)}</span>
                    </div>
                  </div>
                </div>
                </Link>
